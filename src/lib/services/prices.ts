...
export async function getCurrentPrice(ticker: string): Promise<CurrentPriceResult> {
  ...
  if (isNgxTicker(ticker)) {
    ...
    if (ngxPrice) {
      ...
      return { ticker, price: ngxPrice.close, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: 'NGN', stale: false };
    }
    if (cached) {
      return { ticker, price: cached.close, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: cached.currency, stale: true, warning: 'Using stale cached price' };
    }
    return { ticker, price: null, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: 'NGN', stale: false, warning: 'No price available for NGX ticker' };
  }
  ...
  try {
    ...
    if (cached) {
      return { ticker, price: cached.close, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: cached.currency, stale: true, warning: 'Yahoo returned no price, using stale cache' };
    }
    return { ticker, price: null, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency, stale: false, warning: 'No price data available' };
  } catch (err) {
    console.error(`[PriceService] Error fetching ${ticker}:`, err);
    if (cached) {
      return { ticker, price: cached.close, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: cached.currency, stale: true, warning: 'Fetch failed, using stale cache' };
    }
    return { ticker, price: null, previousClose: null, change: null, changePct: null, fiftyTwoWeekHigh: null, fiftyTwoWeekLow: null, fiftyDayAverage: null, twoHundredDayAverage: null, currency: 'USD', stale: false, warning: `Fetch error: ${(err as Error).message}` };
  }
}
